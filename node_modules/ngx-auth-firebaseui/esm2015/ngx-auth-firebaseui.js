...
class AuthComponent {
     ...
     * @param {?} dialog
     */
    constructor(platformId, config, auth, authProcess, dialog) {
...
/** @nocollapse */ LoggedInGuard.ngInjectableDef = defineInjectable({ factory: function LoggedInGuard_Factory() { return new LoggedInGuard(inject(NgxAuthFirebaseUIConfigToken), inject(Router), inject(AuthProcessService)); }, token: LoggedInGuard, providedIn: "root" });
